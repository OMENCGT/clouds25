...
Созданная модель позволяет анализировать потребление от общего (IT Tower) к частному (Usage Type) и готова к использованию в лабораторной работе №2 для кросс-провайдерного сравнения с Azure.
